...
class RqParser:
    """Parser for RecruitQuery. Outputs RqSession."""
    ...
    def Parse(self, tokens):
        ...
        return session.RqSession(self._github, self._field_exprs, self._source, self._condition, self._groups, self._having, self._orders, self._limit)
